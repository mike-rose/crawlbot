...
while (True):
    ...
    for i in range(0, grid_w):
        for j in range(0, grid_h):
            ...
            x,y = i*pixWid+offset, j*pixWid+offset
            ...
            pygame.draw.lines(screen,RED,True,((x,y-radius),(x,y-offset)),10)  #up
            pygame.draw.lines(screen,GREEN,True,((x+radius,y),(x+offset,y)),10)  #right
            pygame.draw.lines(screen,GREEN,True,((x,y+radius),(x,y+offset)),10)  #down
            pygame.draw.lines(screen,RED,True,((x-radius,y),(x-offset,y)),10)  #left
