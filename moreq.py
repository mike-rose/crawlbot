...
for s in range(iterations):
    ...
    for i in range(0, grid_h):
        for j in range(0, grid_w):
            ...
            circle(gui, (190,190,190), (x,y), radius, 0)
            
            q = state[i][j].quality  # [up-q, right-q, down-q, left-q]
            
            line(gui,color(q[0]),True,((x,y-radius),(x,y-offset)),qThick)
            line(gui,color(q[1]),True,((x+radius,y),(x+offset,y)),qThick)
            line(gui,color(q[2]),True,((x,y+radius),(x,y+offset)),qThick)
            line(gui,color(q[3]),True,((x-radius,y),(x-offset,y)),qThick)
